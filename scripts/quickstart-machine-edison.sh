...
REPO_NAME=predix-machine-template-adapter-edison
APP_DIR="edge-edison"
APP_NAME="Edge Starter: Predix Machine for Intel Edison"
...
echo "You can now ssh into Edison using the Edison's ipaddress and start Predix Machine"
echo "" >> "$SUMMARY_TEXTFILE"
