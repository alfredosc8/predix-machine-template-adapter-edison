...
SET REPO_NAME=predix-machine-template-adapter-edison
SET SHELL_SCRIPT_NAME=quickstart-machine-edison.sh
SET APP_DIR="edge-edison"
SET APP_NAME="Edge Starter for Intel Edison"
