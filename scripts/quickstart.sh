...
__echo_run ./quickstart.sh -cs -mc -machine-version 16.4.1 -if $arguments
else
__echo_run ./quickstart.sh -mc -p  -machine-version 16.4.1 $arguments
fi
...
__print_center "Build and setup the Predix Machine Adapter for Edison" "#"
